<x-mail.shell title="Selamat datang">
    ...
    <p style="color:#5a5159;line-height:1.6;">Akaun Lonjak anda dah aktif. Anda kini boleh bina salespage convert tinggi dengan AI, terima order, dan urus semua dari satu dashboard.</p>
